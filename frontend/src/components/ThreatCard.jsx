...
const ThreatCard = ({ title, value, icon, color = "primary", trend }) => {
  const colorClasses = {
    primary:
      "bg-linear-to-br from-primary-900/50 to-primary-800/30 border-primary-600/50 text-primary-300 shadow-lg shadow-primary-900/20",
    danger:
      "bg-linear-to-br from-danger-900/50 to-danger-800/30 border-danger-600/50 text-danger-300 shadow-lg shadow-danger-900/20",
    success:
      "bg-linear-to-br from-success-900/50 to-success-800/30 border-success-600/50 text-success-300 shadow-lg shadow-success-900/20",
    warning:
      "bg-linear-to-br from-warning-900/50 to-warning-800/30 border-warning-600/50 text-warning-300 shadow-lg shadow-warning-900/20",
  };
